class SelecaoDeLevel extends Phaser.Scene {
  ...
  create() {
    ...
    this.add.image(width/2, height/2, 'fundoL').setScale(0.6);
    
    // adiciona os botões de seleção de nivel
    const nivel1 = this.add.image((width/2)-400, ((height/2)+270), 'nivel1').setScale(0.15);
    ...
    const nivel2 = this.add.image((width/2)-200, ((height/2)+250), 'nivel2').setScale(0.15);
    ...
    const nivel3 = this.add.image((width/2), ((height/2)+270), 'nivel3').setScale(0.15);
    ...
    const nivel4 = this.add.image((width/2)+200, ((height/2)+280), 'nivel4').setScale(0.15);  
    ...
    const nivel5 = this.add.image((width/2)+400, ((height/2)+290), 'nivel5').setScale(0.15);  
